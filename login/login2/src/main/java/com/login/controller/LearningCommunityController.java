...
public class LearningCommunityController {
    ...
    public  String deletelearningCommunity(@PathVariable("id") Integer id,
        ...
        System.out.println(11+name+userName);
    ...
    //删除我评论
    @RequestMapping("/deleteMyComment/{id}/{pid}")
    public  String deleteMyComment(@PathVariable("id") Integer id,@PathVariable("pid") Integer pid){


        boolean b = coreService.deleteMyComment(id);
